import pytest
from clases import MiImperio, Almacen, Repuesto, NaveEstelar, Clase, StockInsuficienteError, RepuestoNoEncontradoError


import pytest
from clases import (
    MiImperio, Almacen, Repuesto, NaveEstelar, EstacionEspacial, CazaEstelar,
    Clase, Ubicacion, StockInsuficienteError, RepuestoNoEncontradoError
)
...
# ==========================================
# FIXTURE: Prepara el entorno con tus datos
# ==========================================
@pytest.fixture
def base_imperio():
    imperio = MiImperio()
...
def test_adquirir_repuesto_reduce_stock_correctamente(base_imperio):
...
def test_consultar_repuesto_devuelve_lista_correcta(base_imperio):
    ...
    # Verificamos que encontró exactamente 1 coincidencia
